...
import { HYPERMIND_PROMPT } from '@/app/hypermind/lib/prompts';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await createStreamingResponse(HYPERMIND_PROMPT, content, 'HYPERMIND');
    ...
    console.error('Hypermind API error:', error);
