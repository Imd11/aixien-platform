...
interface ViralInputSectionProps {
  value: string;
...
export default function ViralInputSection({
  value,
  onChange,
  onFileUpload,
  isLoading,
  onAnalyze
}: ViralInputSectionProps) {
    ...
    >
      ...
      <div className="mb-12">
        ...
        >
          ...
          <div 
            className="text-2xl text-center mt-2 font-medium"
      ...
      <div className="space-y-8 w-full flex flex-col items-center">
        ...
        >
          <textarea
            ...
            placeholder="请输入您要创作的文章主题或内容要点，或上传文件进行爆款文章生成..."
